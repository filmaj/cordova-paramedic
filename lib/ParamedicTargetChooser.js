...
ParamedicTargetChooser.prototype.chooseTarget = function (emulator, target, platformVersion) {
    var targetObj = '';
    switch(this.platform) {
        case util.ANDROID:
            targetObj = this.chooseTargetForAndroid(emulator, target, platformVersion);
            break;
        case util.IOS:
            targetObj = this.chooseTargetForIOS(emulator, target, platformVersion);
            break;
        case util.WINDOWS:
            targetObj = this.chooseTargetForWindows(emulator, target, platformVersion);
            break;
        default:
            break;
    }
...
ParamedicTargetChooser.prototype.chooseTargetForIOS = function (emulator, target, version) {
    logger.info('cordova-paramedic: Choosing Target for iOS');
    var simulatorModelId = util.getSimulatorModelId(target, version);
